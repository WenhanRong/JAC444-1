...
public class Student {
    ...
    public boolean equals(Object obj){
        ...
        if(firstName == null) {
            if(student.firstName != null) { return false; }

        } else if(!(firstName.equals(student.firstName))){ return false; }

        if(lastName == null) {
            if(student.lastName != null) { return false; }

        } else if(!(lastName.equals(student.lastName))){ return false; }

        if(grade == null) {
            if(student.grade != null) { return false; }

        } else if(!(grade.equals(student.grade))){ return false; }

        if(department == null) { return student.department == null; }
